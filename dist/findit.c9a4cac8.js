...
searchForm.addEventListener('submit', function (e) {
  ...
  _redditapi2.default.search(searchTerm, searchLimit, sortBy).then(function (results) {
    ...
    results.forEach(function (post) {
      // check for image
      var image = post.preview ? post.preview.images[0].source.url : 'https://assets.entrepreneur.com/content/3x2/1300/20180301190808-reddit-logo.jpeg';
...
},{"./redditapi":8}],4:[function(require,module,exports) {
...
//# sourceMappingURL=/findit.c9a4cac8.map